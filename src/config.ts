...
export const ELEMENTS: ElementConfig[] = [
  { level: 1,  name: 'Funke',  emoji: '✨', color: 0xFF6B35, radius: 18, points: 10   },
  { level: 2,  name: 'Flamme', emoji: '🔥', color: 0xFF2200, radius: 26, points: 20   },
  { level: 3,  name: 'Wasser', emoji: '💧', color: 0x0099FF, radius: 34, points: 40   },
  { level: 4,  name: 'Erde',   emoji: '⛰️', color: 0x9B6B3A, radius: 42, points: 80   },
